...
//}
//
//// getInput n, for n times, fill the list.
//void getInput(leaveRecord list[], int *n)
//{
//    int i;
//    *n = 0;
...
//}
//
//// Given a list of size n, find out if totalleave - leavetaken >= leave
//int mayTakeLeave(leaveRecord list[], int id, int leave, int n)
//{
//    int i = 0;
//    while (i < n){
//        if (list[i].id == id){
//            int currLeave = list[i].totalLeave - list[i].leaveTaken;
//            if (currLeave >= leave) return 1;
//            return 0;
//        }
//        i++;
//    }
