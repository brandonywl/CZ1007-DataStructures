...
double computePay1(int noOfHours, int payRate)
{
    return (noOfHours > 160) ? (160 * payRate) + (noOfHours - 160) * payRate * 1.5 : noOfHours*payRate;
}

void computePay2(int noOfHours, int payRate, double *grossPay)
{
    *grossPay = (noOfHours > 160) ? (double) (160 * payRate) + (double) (noOfHours - 160) * payRate * 1.5 : (double) noOfHours*payRate;
}
*/
