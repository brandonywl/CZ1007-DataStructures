...
double computeSalary1(int noOfHours, int payRate)
{
    return (noOfHours > 160) ? (double) 160 * payRate + (noOfHours-160) * payRate * 1.5 : (double) noOfHours * payRate;
}

void computeSalary2(int noOfHours, int payRate, double *grossPay)
{
    *grossPay = (noOfHours > 160) ? (double) 160 * payRate + (noOfHours-160) * payRate * 1.5 : (double) noOfHours * payRate;
}
*/
